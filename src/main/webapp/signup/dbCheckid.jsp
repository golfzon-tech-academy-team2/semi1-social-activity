...
<script type="text/javascript">
	function sendCheckValue() {
		...
		if (document.checkIdForm.chResult.value=="N") {
			...
			openSignupform.id.focus();
			
			window.close();
		} else {
			// 중복체크 결과인 idCheck 값을 전달
			console.log(openSignupform.isDuplication.value);
			openSignupform.isDuplication.value = "idCheck";
			console.log(openSignupform.isDuplication.value);
			openSignupform.dbCheckId.disabled=true;
			openSignupform.dbCheckId.style.opacity=0.6;
			openSignupform.dbCheckId.style.cursor="default";
			window.close();
		}
